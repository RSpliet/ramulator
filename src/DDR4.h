...
public:
    ...
    struct SpeedEntry {
       ...
       /*rate,        freq,       tCk,BL,CCDsl,RS, CL,RCD, RP,CWL,RAS, RC,RP,WTRsl, WR,  RRD-FAW-RFC ,PD,XPdll,CK,XSdll */
	...
	{3200, (400.0/3)*12,(3/0.4)/12,4, 4, 8, 2, 22, 22, 22, 16, 52, 74, 12,4, 12,24, 0, 0, 0, 0, 0, 8, 10,0, 9, 0, 1024}
